...
<template>
  <div class="grid-info-container" :style="containerStyle">
    ...
    <div class="header">
      ...
      <div class="grid-number">网格编号：{{ details.gridNumber }}</div>
    ...
    <div class="four-grid">
      <div class="grid-item">
        ...
        <div class="item-content">{{ details.safetyIndex }}</div>
        <div class="item-icon">
      ...
      <div class="grid-item">
        ...
        <div class="item-content">{{ details.time }}</div>
        <div class="item-icon">
      ...
      <div class="grid-item">
        ...
        <div class="item-content">{{ details.occupancy }}</div>
        <div class="item-icon">
      ...
      <div class="grid-item">
        ...
        <div class="item-content">{{ details.gridType }}</div>
        <div class="item-icon">
    ...
    <div class="three-columns">
      <div class="column-item">
        ...
        <div class="column-value">{{ details.windSpeed }} m/s</div>
      ...
      <div class="column-item">
        ...
        <div class="column-value">{{ details.visibility }} km</div>
...
import bgShiFeiQu from '@/assets/img/popup/bg_shifeiqu.png'
import bgGuanZhiQu from '@/assets/img/popup/bg_guanzhiqu.png'
import bgJinFeiQu from '@/assets/img/popup/bg_jinfeiqu.png'
...
const containerStyle = computed(() => {
  const imageUrl = backgroundImages[props.details.gridType] || backgroundImages['适飞区']
  return {
