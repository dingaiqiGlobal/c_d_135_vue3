...
class BaiduLayer extends BaseLayer {
  ...
  addTo(viewer, flyTo = false) {
    super.addTo(viewer)
    if (this.zIndex) this.viewer.imageryLayers.add(this.baidu, this.zIndex)
    else this.viewer.imageryLayers.add(this.baidu)
  ...
  remove() {
    if (this.viewer) {
      this.viewer.imageryLayers.remove(this.baidu)
